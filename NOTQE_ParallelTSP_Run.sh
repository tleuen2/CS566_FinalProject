...
#qsubNOTQE28INPUT.pbs -F "1" -l nodes=1:ppn=2
#qsubNOTQE28INPUT.pbs -F "1" -l nodes=1:ppn=4
#qsubNOTQE28INPUT.pbs -F "1" -l nodes=1:ppn=8
qsub NOTQE28INPUT.pbs -F "1" -l nodes=1:ppn=16

#sleep 20

#qsubNOTQE28INPUT.pbs -F "2" -l nodes=2:ppn=1
#qsubNOTQE28INPUT.pbs -F "2" -l nodes=2:ppn=2
#qsubNOTQE28INPUT.pbs -F "2" -l nodes=2:ppn=4
#qsubNOTQE28INPUT.pbs -F "2" -l nodes=2:ppn=8
...
#qsubNOTQE28INPUT.pbs -F "8" -l nodes=8:ppn=1
#qsubNOTQE28INPUT.pbs -F "8" -l nodes=8:ppn=2
...
#qsubNOTQE28INPUT.pbs -F "4" -l nodes=4:ppn=1
#qsubNOTQE28INPUT.pbs -F "4" -l nodes=4:ppn=2
#qsubNOTQE28INPUT.pbs -F "4" -l nodes=4:ppn=4
